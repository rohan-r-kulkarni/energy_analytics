...
cali_1=pd.read_csv("env_health_index/Air/all years/cali-contra costa.csv")
cali_2=pd.read_csv("env_health_index/Air/all years/cali-el dorado.csv")
cali_3=pd.read_csv("env_health_index/Air/all years/cali-imperial.csv")
cali_4=pd.read_csv("env_health_index/Air/all years/cali-mariposa.csv")
cali_5=pd.read_csv("env_health_index/Air/all years/cali-placer.csv")
cali_6=pd.read_csv("env_health_index/Air/all years/cali-san diego.csv")
cali_7=pd.read_csv("env_health_index/Air/all years/cali-san fran.csv")


fl_1=pd.read_csv("env_health_index/Air/all years/fl-bay.csv")
fl_2=pd.read_csv("env_health_index/Air/all years/fl-broward.csv")
fl_3=pd.read_csv("env_health_index/Air/all years/fl-duval.csv")
fl_4=pd.read_csv("env_health_index/Air/all years/fl-leon.csv")
fl_5=pd.read_csv("env_health_index/Air/all years/fl-miami-dade.csv")

nd_1=pd.read_csv("env_health_index/Air/all years/nd-billings.csv")
nd_2=pd.read_csv("env_health_index/Air/all years/nd-cass.csv")
nd_3=pd.read_csv("env_health_index/Air/all years/nd-mercer.csv")

ny_1=pd.read_csv("env_health_index/Air/all years/ny-bronx.csv")
ny_2=pd.read_csv("env_health_index/Air/all years/ny-chautauqua.csv")
ny_3=pd.read_csv("env_health_index/Air/all years/ny-queens.csv")
ny_4=pd.read_csv("env_health_index/Air/all years/ny-suffolk.csv")
ny_5=pd.read_csv("env_health_index/Air/all years/ny-westchester.csv")

oh_1=pd.read_csv("env_health_index/Air/all years/oh-butler.csv")
oh_2=pd.read_csv("env_health_index/Air/all years/oh-cuyahoga.csv")
oh_3=pd.read_csv("env_health_index/Air/all years/oh-franklin.csv")
oh_4=pd.read_csv("env_health_index/Air/all years/oh-hamilton.csv")

ok_1=pd.read_csv("env_health_index/Air/all years/ok-cleveland.csv")
ok_2=pd.read_csv("env_health_index/Air/all years/ok-comanche.csv")
ok_3=pd.read_csv("env_health_index/Air/all years/ok-pittsburg.csv")

penn_1=pd.read_csv("env_health_index/Air/all years/penn-centre.csv")
penn_2=pd.read_csv("env_health_index/Air/all years/penn-dauphin.csv")
penn_3=pd.read_csv("env_health_index/Air/all years/penn-northampton.csv")
penn_4=pd.read_csv("env_health_index/Air/all years/penn-philadelphia.csv")
penn_5=pd.read_csv("env_health_index/Air/all years/penn-washington.csv")
penn_6=pd.read_csv("env_health_index/Air/all years/penn-york.csv")


tx_1=pd.read_csv("env_health_index/Air/all years/tx-brazoria.csv")
tx_2=pd.read_csv("env_health_index/Air/all years/tx-cameron.csv")
tx_3=pd.read_csv("env_health_index/Air/all years/tx-dallas.csv")
tx_4=pd.read_csv("env_health_index/Air/all years/tx-galveston.csv")
tx_5=pd.read_csv("env_health_index/Air/all years/tx-nueces.csv")
tx_6=pd.read_csv("env_health_index/Air/all years/tx-travis.csv")


wv_1=pd.read_csv("env_health_index/Air/all years/wv-brooke.csv")
wv_2=pd.read_csv("env_health_index/Air/all years/wv-marshall.csv")
wv_3=pd.read_csv("env_health_index/Air/all years/wv-tucker.csv")
wv_4=pd.read_csv("env_health_index/Air/all years/wv-wood.csv")


wy_1=pd.read_csv("env_health_index/Air/all years/wy-albany.csv")
wy_2=pd.read_csv("env_health_index/Air/all years/wy-lincoln.csv")
wy_3=pd.read_csv("env_health_index/Air/all years/wy-sublette.csv")
wy_4=pd.read_csv("env_health_index/Air/all years/wy-teton.csv")
...
california.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/california_raw.csv',encoding='utf-8', index=False)
florida.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/florida_raw.csv',encoding='utf-8', index=False)
n_dakota.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/n_dakota_raw.csv',encoding='utf-8', index=False)
new_york.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/new_york_raw.csv',encoding='utf-8', index=False)
ohio.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/ohio_raw.csv',encoding='utf-8', index=False)
oklahoma.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/oklahoma_raw.csv',encoding='utf-8', index=False)
pennsylvania.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/pennsylvania_raw.csv',encoding='utf-8', index=False)
texas.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/texas_raw.csv',encoding='utf-8', index=False)
w_virginia.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/w_virginia_raw.csv',encoding='utf-8', index=False)
wyoming.to_csv('env_health_index/Air/merged data(to be filled)/raw data by state/wyoming_raw.csv',encoding='utf-8', index=False)
...
california_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/california_raw.csv")[['Date','average']]
texas_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/texas_raw.csv")[['Date','average']]
n_dakota_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/n_dakota_raw.csv")[['Date','average']]
wyoming_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/wyoming_raw.csv")[['Date','average']]
pennsylvania_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/pennsylvania_raw.csv")[['Date','average']]
w_virginia_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/w_virginia_raw.csv")[['Date','average']]
oklahoma_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/oklahoma_raw.csv")[['Date','average']]
new_york_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/new_york_raw.csv")[['Date','average']]
ohio_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/ohio_raw.csv")[['Date','average']]
florida_av = fill_nans_row_avg_for_state("env_health_index/Air/merged data(to be filled)/raw data by state/florida_raw.csv")[['Date','average']]
...
d10.columns = [ "California", "Texas","North.Dakota","Wyoming", "Pennsylvania", "West.Virginia", "Oklahoma", "New.York", "Ohio", "Florida"]

d10.index = d10.index.to_period('M').to_timestamp('M') - pd.offsets.MonthBegin(1)
d10.index.name = None

d10.to_csv('clean_data/resp/clean_AQI.csv',encoding='utf-8', index=True)
